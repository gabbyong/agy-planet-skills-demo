...
- `.agents/skills/visualize-dataset/`: Skill for progressive dataset exploration and analysis.
- `examples/`: Standalone interactive HTML and Manim animation artifacts generated by skills.
